...
public class CheckResultDO {
    ...
    private String hideFlag; //已处理标记位
    private String aprrovtl; //审核员
    private String aprrovtltime;//审核时间
    private String tl;//操作员
    private String flag;//审核状态  0或者null，初始状态，1为已提交，2为审核通过，3为已驳回，4为差错处理失败
    private String dataType;//数据类型, 例如是个人对账还是对公对账
    ...
    public String getAprrovtl() {
        return aprrovtl;
    }

    public void setAprrovtl(String aprrovtl) {
        this.aprrovtl = aprrovtl;
    }
    ...
    public String getAprrovtltime() {
        return aprrovtltime;
    }

    public void setAprrovtltime(String aprrovtltime) {
        this.aprrovtltime = aprrovtltime;
    }
