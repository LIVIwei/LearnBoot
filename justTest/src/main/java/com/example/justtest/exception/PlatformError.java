package com.example.justtest.exception;
...
public class PlatformError {
    ...
    public static PlatformError DATABASE_EXECUTE_ERROR      = new PlatformError("BE000001", "database execute error");
    ...
    public static PlatformError COMM_ABEND                  = new PlatformError("BE000011", "communication exception");
    public static PlatformError SIGN_ERROR                  = new PlatformError("BE000901", "签名异常");
    public static PlatformError SIGN_VERIFY_ERROR           = new PlatformError("BE000902", "验签异常");
    public static PlatformError SIGN_VERIFY_FAIL           = new PlatformError("BE000902", "sign exception");
    public static PlatformError ENCRYPT_DECRYPT_ERROR              = new PlatformError("BE000905", "加解密异常");
    public static PlatformError ENCRYPT_ERROR              = new PlatformError("BE000906", "加密异常");
    public static PlatformError DECRYPT_ERROR              = new PlatformError("BE000907", "解密异常");
