package com.example.justtest.controller.batch;

import com.example.justtest.constant.AppConstant;
import com.example.justtest.enums.TaskGroupEnum;
...
public class BatchController extends BaseController {
    ...
    public TableDataInfo carryForward(@RequestParam("settleDate") String settleDate, @RequestParam("dataType") String dataType) throws Exception {
        String crdtparty= AppConstant.getINSTFinancialInstitutionCd();//指定交行 机构代码
